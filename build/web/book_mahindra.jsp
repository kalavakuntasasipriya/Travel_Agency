...
<body>
	...
	<div class="main">
		...
		<form class="form" action="bmw" method="post" name="myform" >
				...
				<input class="input" value="Mahindra XUV 500 2011" name="car_name"  readonly >
                                <span><b>Type of car:</b></span>
				<input class="input" value="AC" name="type"  readonly >
                                <span><b>Date of booking</b></span>
				<input class="input" type="date" name="bookingdate" >
                                <span><b>Charge per hour</b></span>
                                <input class="input" value="4200" name="charge_per_hour"   readonly >
